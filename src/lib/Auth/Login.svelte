    ...
    <div class="h-28 rounded-t w-full bg-dark-blue">
      <div class="flex items-center justify-between  p-2 text-sm text-blue-500">
        ...
        <img
          ...
          src="http://skote-v-dark.svelte.themesbrand.com/assets/images/profile-img.png"
          alt=""
        />
      </div>
    </div>
    ...
    >
      ...
      <div class="flex w-full flex-col items-center justify-center">
        ...
        <div class=" flex gap-4 pb-3">
          ...
          <div
            class=" h-8 w-8 rounded-full flex items-center justify-center text-white bg-[#50A5F1]"
          >
            <svg
          ...
          <div
            class=" h-8 w-8 flex items-center justify-center rounded-full bg-red-600 text-white text-base font-semibold"
          >
            G
          </div>
        </div>
