...
<div class="absolute  hidden  py-3 px-3 lg:flex  top-0 right-1">
    <a href="/" class="h-8 w-8 text-white">
        <svg xmlns="http://www.w3.org/2000/svg" class="stroke-current" width="24" height="24" viewBox="0 0 24 24"
...
<form
    ...
    <div class=" min-h-64 min-h-[80vh] flex flex-col w-full rounded bg-gray-secondary">
        <div class="h-28 rounded-t w-full bg-dark-blue">
            <div class="flex items-center justify-between  p-2 text-sm text-blue-500">
                ...
                <img class="h-20 w-32 object-fit"
                     src="http://skote-v-dark.svelte.themesbrand.com/assets/images/profile-img.png" alt="">
            </div>
        </div>
        ...
        <div class="flex-grow pt-12 flex flex-col  justify-between w-full px-6 lg:px-8 ">
            ...
            <div class="w-full py-2">
                <button class="bg-primary w-full px-3 py-2 rounded hover:bg-opacity-80 text-white"
                        on:click|preventDefault={handleSubmit}>Login
                </button>
            </div>
            ...
            <div class="flex w-full flex-col items-center justify-center">
                ...
                <div class=" flex gap-4 pb-3">
                    <div class=" ">
                        <img src="https://cdn.worldvectorlogo.com/logos/facebook-3-2.svg" class="h-8 w-8 rounded-full "
                             alt="">
                    </div>
                    <div class=" h-8 w-8 rounded-full flex items-center justify-center text-white bg-[#50A5F1]">
                        <svg class="fill-current h-4 w-4" focusable="false" aria-hidden="true" viewBox="0 0 24 24"
                             data-testid="TwitterIcon" aria-label="fontSize large">
                ...
                <div class="flex gap-2 items-center text-gray-300 mb-3">
                    <svg class="stroke-current h-4 w-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
    ...
    <div class="footer flex items-center flex-col gap-4 my-4 jusfify-center">
        <p class="text-gray-200 text-[13px] ">Don't have an account? <a href="/" class="text-blue-500">Signup now!</a>
        </p>
