...
class="w-full mt-10 lg:w-1/3 mx-auto  min-h-screen flex flex-col items-center justify-center">
                     <!-- START USER CARD -->
                     <div class=" min-h-64 min-h-[90vh] flex flex-col w-full rounded bg-gray-secondary">
                       <div class="h-28 rounded-t w-full bg-dark-blue">
                         <div class="flex items-center justify-between  p-2 text-sm text-blue-500">
                           <div class="flex flex-col  px-2 text-sm text-primary">
                            ...
                            <p class="text-xs">Skate Dashbard!</p>
                           </div>
                      ...
                      <div class="flex-grow flex flex-col  justify-between w-full px-6 lg:px-8 pt-6">
 
                     <BaseInput type="text" label="username" model={model.username}/>

                     <BaseInput type="password" label="password" model={model.password}/>
                       <div class="group flex items-center text-gray-500 mb-4 w-full gap-2 relative">
                       ...
                       <div class="flex w-full flex-col items-center justify-center">
                         <h4 class="text-sm font-medium text-white mb-6 ">Sign in With</h4>
